...
// Small, monochrome line icons (stroke uses currentColor, so they inherit
// whatever color the surrounding button/text has). Kept as plain inline SVG
// rather than an icon library dependency to keep the project lightweight.
...
export function SkipPrevIcon(props) {
  return (
    <svg {...base} {...props}>
